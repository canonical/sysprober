# Contributing to `sysprober`

Do you want to contribute to the `sysprober` repository? You've come to the right place then!
...
you can use this guide for specific information on contributing to the `sysprober` repository.
...
## Hacking on `sysprober`

This repository uses [tox](https://tox.wiki/) for development
...
### Before opening a pull request on the `sysprober` repository
...
required tests. You can run the required tests locally using `tox`:
...
By contributing to `sysprober`, you agree to license your contribution under
the Apache License 2.0 license.

### Adding a new file to `sysprober`
...
### Updating an existing file in `sysprober`
...
```text
Copyright 2022-2026 Canonical Ltd.
```
